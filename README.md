...
kicksharing.csv – файл с информацией об аренде самокатов 2024 года (с апреля по октябрь 2024).
<<<<<<< HEAD
...
3. Было выявлено что в данных есть ошибка связанная с длиной поездки. Данные были обработаны и отделены для отдельного анализа
4. Был произведен анализ данных по:
- моделям самокатов
- демографический анализ (пол, возраст, уровень образования и семейный статус)
- анализ активности пользователей (когортный анализ, распределение поездок по дню недели и времени суток)
- региональный аналищ поездок
